...
* @member numShips {number} The number of ships each player will place
* @member turn {boolean} Which player's turn it is (players are false and true, corresponding to 0 and 1)
* @member isSetup {boolean} Whether the ship placement phase of gameply has been completed
